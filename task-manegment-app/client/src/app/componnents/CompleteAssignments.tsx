...
interface AssignmentsProps {
 ...
 function CompleteAssignments({ assignments , setAssignments}: AssignmentsProps) {
  ...
  return (
    <div>
      { assignments.filter((a) => a.isComplete).map((assignment) => (
        <div
          key={assignment.id}
          className="flex items-center justify-between gap-4 mb-2 p-2 border-b border-gray-200"
        >
          <span 
            className={`flex-1 ${
